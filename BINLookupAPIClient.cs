...
namespace APIVerve
{
    ...
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/binlookup";
        ...
        public BINLookupAPIClient(string apiKey, bool isSecure = true)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
        }
        ...
        public BINLookupAPIClient(string apiKey, bool isSecure = true, bool isDebug = false)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
            _isDebug = isDebug;
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, BINLookupQueryOptions options = null)
        {
        ...
        /// <param name="options"></param>
        /// <returns></returns>
        public ResponseObj Execute(BINLookupQueryOptions options = null)
        {
            try
            {
                if (_isDebug)
        ...
        private string constructURL(BINLookupQueryOptions options)
        {
